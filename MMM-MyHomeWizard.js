Module.register('MMM-MyHomeWizard', {
    ...
    // … rest van addPowerRows, addWaterRows, addExtraInfo blijft hetzelfde
    // Gebruik this.formatNumber(data.whatever) voor alle getallen
    ...
    processMHW_P1: function(data) {
        ...
        this.loadedP1 = true;
        this.errorP1 = false;
        if ((this.config.P1_IP ? this.loadedP1 : true) && (this.config.WM_IP ? this.loadedWM : true)) {
            if (this.config.showLastUpdate) this.readLastUpdate();
